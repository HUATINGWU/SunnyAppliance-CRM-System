...
<div class="panel-group" id="accordion">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseThree" class="panel-collapse collapse">
            <div class="panel-body">
                <ul>
                    <li><a class="links" href="../../customOrder/index" target="content">订单查询</a></li>
                    <li><a class="links" href="../../afterSale/Index/index" target="content">Check Aftersalelists</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseTwo" class="panel-collapse collapse">
            <div class="panel-body">
                ...
                <?php
                    $a = $_COOKIE['department_id'];
                    echo"<li id='link1'><a  class='links' href='../../Department/department/department.html?department_id=$a' target='content'>商品查询</a></li>";
                ?>
                </ul>
            </div>
        </div>
